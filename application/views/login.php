                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="input-group">
                      <button class="btn btn-primary input-group px-4" type="submit">submit</button>
                    </div>
                  </div>
                  </form>
                  <br>
                  ...
                  <div class="text-center">
                    <a class="small" href="<?php echo base_url('auth/registrasi');?>">Belum punya akun? Registrasi</a>
                  </div>
                </div>
              </div>
            </div>
