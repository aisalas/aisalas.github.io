...
<html lang="en">
  <head>
    ...
    <meta name="msapplication-TileImage" content="<?php echo base_url('assets/admin/dist/assets/favicon/ms-icon-144x144.png');?>">
    ...
    <link href="<?php echo base_url('assets/admin/dist/vendors/@coreui/chartjs/css/coreui-chartjs.css');?>" rel="stylesheet">
  </head>
